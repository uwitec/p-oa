...
class pinyin {
	...
	public function first_letter($zh,$code='UTF8'){
		...
		for($i=0; $i<strlen($zh); $i++) { 
			...
			$res= $this->_pinyin($ASCII, $this->data_key);
			$first_letter.=substr($res,0,1);
		} 
	    return preg_replace("/[^a-zA-Z0-9_-]*/", '', $first_letter); 
	}
	/**
	 * ASCII码转为拼音
	 *
